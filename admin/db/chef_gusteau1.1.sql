...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-12-2019 a las 02:59:09
...
INSERT INTO `compras` (`id`, `proveedor`, `fecha`, `id_insumo`, `cantidad`, `precio`, `total`) VALUES
(1, 1, '2019-12-03', 1, 500, '1.75', '875.00'),
(2, 1, '2019-12-03', 1, 500, '1.75', '875.00'),
(3, 1, '2019-12-03', 1, 500, '1.75', '875.00'),
(4, 1, '2019-12-03', 1, 500, '1.75', '875.00'),
(5, 1, '2019-12-03', 1, 500, '1.75', '875.00'),
(6, 1, '2019-12-03', 1, 500, '1.75', '875.00');
...
(1, 'Pechuga de pollo', 'Pechuga de pollo grande', 3000, 'lb', '2019-12-03 05:18:50', '2019-12-04 01:53:53'),
(2, 'Tomates Cherry', 'Tomates Cherry', 0, '-', '2019-12-03 05:19:26', '2019-12-04 01:42:07'),
...
(1, 'Luis Iraheta', '+503 7574-7574', '+503 7574-7574', 'liluisjose1@gmail.com', 'Barrio el Centro Chirilagua', '2500.00'),
(3, 'Yenifer Garca', '52566655', '52566655', 'yeni@gmail.com', 'etc', '0.00');
...
INSERT INTO `recetas` (`id`, `nombre`, `fecha_creacion`, `fecha_modificacion`) VALUES
(1, 'POLLO A LA API', '2019-12-03 16:47:23', NULL),
(2, 'Carnita Azada API', '2019-12-03 21:11:48', NULL);
