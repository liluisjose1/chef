...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-12-2019 a las 05:17:02
...
(3, 'Luis Iraheta', '+503 2681-9233', '+503 7574-7554', 'liluisjose1@gmail.com', 'Barrio el Centro Chirilagua');
...
INSERT INTO `reservaciones` (`id`, `id_cliente`, `anticipo`, `espacio`, `fecha`) VALUES
(1, 1, '500.00', 1, '2019-12-05 16:08:07'),
(2, 1, '2.00', 4, '2019-12-05 16:26:39'),
(3, 1, '3000.00', 3, '2019-12-25 00:00:00'),
(5, 3, '3000.00', 1, '2020-01-02 21:00:00');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `reservas_online`
--
...
--
-- Volcado de datos para la tabla `reservas_online`
--

INSERT INTO `reservas_online` (`id`, `nombre`, `email`, `tel`, `mensaje`, `fecha`) VALUES
(1, 'Luis Iraheta', 'liluisjose1@gmail.com', '75747554', 'Prueba', '2019-12-05 06:00:00');
...
(4, 1, 1, '2000.00', '2019-12-05 17:16:06');
...
(60, 'CLIENTE PRUEBA', '1500.00', '2019-12-05 17:13:11');
...
--
-- Indices de la tabla `reservas_online`
--
ALTER TABLE `reservas_online`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `reservas_online`
--
ALTER TABLE `reservas_online`
