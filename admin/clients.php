								...
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<div class="modal-body">
											<form action="operations/client_save.php" method="post">
												<div class="row">
													<div class="col-sm-12">
							...
							<div class="modal fade" id="update_user" tabindex="-1" role="dialog" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<div class="modal-body">
											<form action="operations/client_update.php" method="post">
												...
												<div class="row">
													...
													<div class="col-sm-12">
														<div class="form-group form-group-default">
															<label>Dirección</label>
															<input id="direccion1" name="direccion" type="text" class="form-control" placeholder="Direccion">
														</div>
													</div>
												</div>
										</div>
	...
	$(document).ready(function() {
		...
		$('.delete_data').click(function(e) {
			...
			swal({
				...
				if (Delete) {
					$.ajax({
						url: "operations/client_delete.php",
						type: "POST",
						data: {
							id_user: user_id
						},
		...
		$(document).on('click', '.edit_data', function() {
			...
			var user_id = $(this).attr("id");
			$.ajax({
				url: "operations/client_ajax_select.php",
				method: "POST",
				data: {
					user_id: user_id
				},
